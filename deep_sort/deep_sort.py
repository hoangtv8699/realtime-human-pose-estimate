...
class DeepSort(object):
    def __init__(self, model_path, max_dist=0.2, max_iou_distance=0.7,
                 max_age=100, n_init=3, nn_budget=100, use_cuda=True):
    ...
    def update(self, bbox_xyxy, confidences, ori_img):
        ...
        detections = [Detection(bbox_tlwh[i], confidences[i], features[i]) for i in range(len(confidences))]
